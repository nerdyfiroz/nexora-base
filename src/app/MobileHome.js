    ...
    <>
      ...
      <header style={{ width: '100%', maxWidth: 480, margin: '0 auto', textAlign: 'center', padding: '1.2rem 0 0.5rem 0', boxSizing: 'border-box' }}>
        <div style={{display:'flex',justifyContent:'center',alignItems:'center',gap:'1rem',marginBottom:'0.7rem'}}>
          <img src="/images/nft_226.png" alt="Header NFT 1" style={{width:'44px',height:'44px',borderRadius:'0.7rem',background:'#fff',maxWidth:'100%'}} />
          <span style={{ fontFamily: 'Space Grotesk, Arial', fontWeight: 900, fontSize: '2rem', letterSpacing: '0.04em', color: '#222' }}>NEXORA</span>
          <img src="/images/nft_16.png" alt="Header NFT 2" style={{width:'44px',height:'44px',borderRadius:'0.7rem',background:'#fff',maxWidth:'100%'}} />
        </div>
      ...
      <section style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'1rem',background:'#fff',borderRadius:'1rem',padding:'1rem 0.7rem',margin:'0 0.5rem 1rem 0.5rem',maxWidth:480,width:'100%',boxSizing:'border-box',marginLeft:'auto',marginRight:'auto'}}>
        ...
        <div style={{background:'#f8f8f6',borderRadius:'1rem',padding:'1rem',display:'flex',flexDirection:'column',alignItems:'center',position:'relative',width:'100%',maxWidth:'240px',margin:'0 auto', boxSizing:'border-box', overflowX:'hidden'}}>
          <img src="/images/nft_102.png" alt="NEXORA NFT" style={{width:'120px',height:'120px',borderRadius:'1rem',marginBottom:'1rem',background:'#fff',maxWidth:'100%'}} />
        ...
        <div style={{display:'flex',alignItems:'center',gap:'0.5rem',marginTop:'0.7rem',justifyContent:'center'}}>
          <img src="/images/nft_11.png" alt="NEXORA Avatar 1" style={{width:'28px',height:'28px',borderRadius:'50%',border:'2px solid #fff',maxWidth:'100%'}} />
          <img src="/images/nft_16.png" alt="NEXORA Avatar 2" style={{width:'28px',height:'28px',borderRadius:'50%',border:'2px solid #fff',maxWidth:'100%'}} />
          <img src="/images/nft_54.png" alt="NEXORA Avatar 3" style={{width:'28px',height:'28px',borderRadius:'50%',border:'2px solid #fff',maxWidth:'100%'}} />
          <img src="/images/nft_3.png" alt="NEXORA Avatar 4" style={{width:'28px',height:'28px',borderRadius:'50%',border:'2px solid #fff',maxWidth:'100%'}} />
          <img src="/images/nft_8.png" alt="NEXORA Avatar 5" style={{width:'28px',height:'28px',borderRadius:'50%',border:'2px solid #fff',maxWidth:'100%'}} />
      ...
      <footer style={{ textAlign: 'center', margin: '1.5rem 0 1rem 0', fontSize: '0.95rem', color: '#333', boxSizing: 'border-box', maxWidth: 480, marginLeft: 'auto', marginRight: 'auto' }}>
        <img src="/images/rumiilyan.jpeg" alt="Rumi Ilyan" style={{ width: '28px', height: '28px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto 0.5rem auto', maxWidth:'100%' }} />
